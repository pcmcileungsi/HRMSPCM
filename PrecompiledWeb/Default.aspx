<%@ page language="C#" autoeventwireup="true" inherits="_Default, App_Web_cuexosyb" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>eChannelling | PT. Tifa Finance Tbk.</title>
...
<body>
    ...
    <asp:UpdatePanel ID="pnlMain" runat="server" UpdateMode="Conditional" EnableViewState="true">
        <ContentTemplate>
            <div class="login">
                <span style="font-size: 18px; font-weight: bold; color: rgb(38,68,110);">Channelling
                    System Login</span>
                <br />
            ...
            <div style="width: 500px; margin: 0px auto; text-align: center; color: rgb(38,68,110)">
                <span>&copy; PT TIFA FINANCE Tbk, 2015. All rights reserved.</span>
            </div>
        </ContentTemplate>
