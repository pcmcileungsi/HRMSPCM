<%@ page language="C#" masterpagefile="~/mfin.master" autoeventwireup="true" inherits="module_sysadmin_userdetail, App_Web_5xutsobd" title="Untitled Page" %>
    ...
    <div>
        ...
        <div id="page-1" class="ui-corner-bottom" style="padding: 2px 2px; background-color: #eeeeff;
            ...
            <table cellpadding="4px" cellspacing="0px" width="100%" border="0px">
                <tr>
                    <td>
                        <cc1:XUIButton ID="btnAdd" runat="server" CssClass="add" Text="Add" OnClick="btnAdd_Click" RoleCode="B000510" />
                    </td>
                    <td align="right">
