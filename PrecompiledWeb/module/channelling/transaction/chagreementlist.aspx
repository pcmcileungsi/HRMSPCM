<%@ page title="" language="C#" masterpagefile="~/mfin2.master" autoeventwireup="true" inherits="module_channelling_transaction_chagreementlist, App_Web_pt4ne0vj" %>
...
//            jsPopUpDate("ctl00_cphbd_dtToDateMurabahah");
        ...
        <tr>
            <td colspan="2" style="border-bottom: solid 1px #dedede">
                <span class="search-header">Application List</span>
            </td>
        </tr>
    </table>
    <div id="pages" style="margin: 5px 3px">
        <ul style="font-size: smaller">
            ...
            <li><a href="#page-1"><span>Pending Batch</span></a></li>
            <li><a href="#page-2"><span>Pending Disbursement</span></a></li>
            <li><a href="#page-3"><span>Disbursement</span></a></li>
        </ul>
        <div id="page-0" class="ui-corner-bottom" style="padding: 2px 2px; background-color: #eeeeff;
            ...
            <table id="tblBody" cellpadding="3px" cellspacing="0px" class="search-list-table">
                <tr>
                    <td align="left">
                        <cc1:XUIButton ID="btnAdd" runat="server" CssClass="add" Text="Add" OnClick="btnAdd_Click" RoleCode="B200011" />
                        <%--<cc1:XUIButton ID="btnApprove" runat="server" CssClass="post" Text="Approve Selected" OnClick="btnApprove_Click"  RoleCode="B200015"/>--%>
                        <cc1:XUIButton ID="btnReject" runat="server"  CssClass="void" Text="Reject Selected" OnClick="btnReject_Click" RoleCode="B200015" />
                    </td>
                    <td align="right">
                ...
                <tr>
                    <td colspan="2">
                        <asp:UpdatePanel ID="updPanel" UpdateMode="Conditional" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gvwListPending" runat="server" AutoGenerateColumns="False" DataKeyNames="LS_AGREEMENTID"
        ...
        <div id="page-1" class="ui-corner-bottom" style="padding: 2px 2px; background-color: #eeeeff;
            ...
            <table id="tblBody1" cellpadding="3px" cellspacing="0px" class="search-list-table">
                <tr>
                    <td align="right">
                        <asp:Panel ID="pnlSearchPendingBatch" runat="server" DefaultButton="btnSearchPendingBatch">
                            <asp:TextBox ID="txtSearchPendingBatch" runat="server"></asp:TextBox>
                            <asp:Button ID="btnSearchPendingBatch" runat="server" CssClass="search" Text="Search"
                                OnClick="btnSearchPendingBatch_Click" />
                        </asp:Panel>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:UpdatePanel ID="updPanel1" UpdateMode="Conditional" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gvwListPendingBatch" runat="server" AutoGenerateColumns="False" DataKeyNames="LS_AGREEMENTID"
                                    OnSelectedIndexChanged="gvwListPendingBatch_SelectedIndexChanged" EmptyDataText="There is no data."
                                    AllowPaging="true" PageSize="10" OnPageIndexChanging="gvwListPendingBatch_PageIndexChanging"
                                    OnRowCreated="gvwListPendingBatch_RowCreated" GridLines="None" CssClass="mGrid"
                                    PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnSelectPendingBatch" runat="server" CausesValidation="False"
                                                    CommandName="Select" ImageUrl="~/img/im4_grid_edit.png" ToolTip="Edit" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                            ...
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="btnSearchPendingBatch" EventName="Click" />
                                <asp:AsyncPostBackTrigger ControlID="btnRejection" EventName="Click" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </td>
                ...
                <tr>
                    <td>
                        <asp:UpdatePanel ID="updPanel2" UpdateMode="Conditional" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gvwListPendingDisbursement" runat="server" AutoGenerateColumns="False"
                                    DataKeyNames="LS_AGREEMENTID" OnSelectedIndexChanged="gvwListPendingDisbursement_SelectedIndexChanged"
                                    EmptyDataText="There is no data." AllowPaging="true" PageSize="10" OnPageIndexChanging="gvwListPendingDisbursement_PageIndexChanging"
                ...
                <tr>
                    <td align="right">
                        <asp:Panel ID="pnlSearchDisbursement" runat="server" DefaultButton="btnSearchDisbursement">
                            ...
                            <asp:Button ID="btnSearchDisbursement" runat="server" CssClass="search" Text="Search" OnClick="btnSearchDisbursement_Click" />
                        </asp:Panel>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:UpdatePanel ID="updPanel3" UpdateMode="Conditional" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gvwListDisbursement" runat="server" AutoGenerateColumns="False" DataKeyNames="LS_AGREEMENTID"
                                    OnSelectedIndexChanged="gvwListDisbursement_SelectedIndexChanged" EmptyDataText="There is no data."
                                    AllowPaging="true" PageSize="10" OnPageIndexChanging="gvwListDisbursement_PageIndexChanging"
                                    OnRowCreated="gvwListDisbursement_RowCreated" GridLines="None" CssClass="mGrid" PagerStyle-CssClass="pgr"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnSelectDisbursement" runat="server" CausesValidation="False" CommandName="Select"
