<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="chtblmakelist.aspx.cs"
    Inherits="module_channelling_transaction_chtblmakelist" Title="Untitled Page" %>
    ...
    <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="search-header-table">
        <tr>
            <td colspan="2" style="border-bottom: solid 1px #dedede">
                <span class="search-header">List Assets Merk</span>
            </td>
        </tr>
        <tr>
            <td>
                <cc2:XUIButton ID="btnAdd" runat="server" CssClass="add" Text="Add" OnClick="btnAdd_Click" RoleCode="B200001" />
                <cc2:XUIButton ID="btnDelete" runat="server" CssClass="delete" Text="Delete" OnClick="btnDelete_Click" RoleCode="B200003" />
            </td>
            <td align="right">
        ...
        <tr>
            <td>
                <asp:UpdatePanel ID="updMain" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="False" DataKeyNames="CH_TBLMAKEID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CODE" HeaderText="Make Code">
