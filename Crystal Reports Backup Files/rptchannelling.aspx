<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="rptchannelling.aspx.cs" Inherits="module_channelling_report_rptchannelling" Title="Untitled Page" %>
        ...
        <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="detail-header-table">
            <tr>
                <td colspan="2" style="border-bottom: solid 1px #dedede">
                    <span class="search-header">Channelling Report</span>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <asp:UpdatePanel ID="pnlBody" runat="server">
            <ContentTemplate>
                <table id="tblBody" cellpadding="4px" cellspacing="0px" width="100%" border="0px">
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:Button ID="btnPrint" runat="server" CssClass="print" Text="Print" OnClick="btnPrint_Click" RoleCode="B200018" />
                        </td>
                        <td  align="right">
