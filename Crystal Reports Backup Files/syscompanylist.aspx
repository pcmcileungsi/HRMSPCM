<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="syscompanylist.aspx.cs"
    Inherits="module_sysadmin_master_syscompanylist" Title="Untitled Page" %>
    ...
    <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="search-header-table">
        <tr>
            <td colspan="2" style="border-bottom: solid 1px #dedede">
                <span class="search-header">Unit Company List</span>
            </td>
        </tr>
        <tr>
            <td>
                <cc2:XUIButton ID="btnAdd" runat="server" CssClass="add" Text="Add" OnClick="btnAdd_Click" RoleCode="B000509" />
            </td>
            <td align="right">
        ...
        <tr>
            <td>
                <asp:UpdatePanel ID="updMain" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="False" DataKeyNames="SYS_COMPANYID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="C_CODE" HeaderText="Company Code">
                                    <ItemStyle Width="15%" HorizontalAlign="center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="C_NAME" HeaderText="Company Name">
                                    <ItemStyle Width="50%" HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="C_NPWP" HeaderText="NPWP No.">
