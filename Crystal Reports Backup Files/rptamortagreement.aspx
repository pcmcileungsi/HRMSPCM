<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="rptamortagreement.aspx.cs" Inherits="module_channelling_report_rptamortagreement" Title="Untitled Page" %>
        ...
        <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="detail-header-table">
            <tr>
                <td colspan="2" style="border-bottom: solid 1px #dedede">
                    <span class="search-header">Agreement amortisation schedule</span>
                </td>
            </tr>
            <tr>
                <td>
