<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="rptamortchannelling.aspx.cs" Inherits="module_channelling_report_rptamortchannelling" Title="Untitled Page" %>
        ...
        <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="detail-header-table">
            <tr>
                <td colspan="2" style="border-bottom: solid 1px #dedede">
                    <span class="search-header">Channelling amortisation schedule</span>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <ContentTemplate>
                <table id="tblBody" cellpadding="4px" cellspacing="0px" width="100%" border="0px">
                    <tr>
                        ...
                        <td width="80%">
                            <cc1:XUIRadioButtonList ID="rboType" runat="server" DataType="String" BindType="None"
                                SPParameterName="p_type" RepeatDirection="Horizontal" 
                                RepeatLayout="Flow">
                                <asp:ListItem Value="1" Selected="True">Nasabah</asp:ListItem>
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:UpdatePanel ID="updMain" UpdateMode="Conditional" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="False" DataKeyNames="LSAGREE" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                             ...
                                             <asp:BoundField DataField="LSAGREE" HeaderText="Nomor Agreement">
