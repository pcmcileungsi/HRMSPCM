<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="rptrentalagreement.aspx.cs" Inherits="module_channelling_report_rptrentalagreement" Title="Untitled Page" %>
        ...
        <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="detail-header-table">
            <tr>
                <td colspan="2" style="border-bottom: solid 1px #dedede">
                    <span class="search-header">Agreement AR Ledger</span>
                </td>
            </tr>
            <tr>
                <td>
