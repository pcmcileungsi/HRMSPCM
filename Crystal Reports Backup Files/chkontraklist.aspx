<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="chkontraklist.aspx.cs" Inherits="module_channelling_report_chkontraklist" Title="Untitled Page" %>
    ...
    <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="search-header-table">
        <tr>
            <td style="border-bottom: solid 1px #dedede">
                <span class="search-header">Print Contract/Contract Agreement Letter</span>
            </td>
        </tr>
        <tr>
            <td align="right">
