<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="cutilist.aspx.cs"
    Inherits="module_transaksi_cutilist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphbd" runat="Server">
    ...
    <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="search-header-table">
        <tr>
            <td colspan="2" style="border-bottom: solid 1px #dedede">
                <span class="search-header">List Cuti</span>
    ...
    <div id="pages" style="margin: 5px 3px">
        <ul style="font-size: smaller">
            ...
            <li><a href="#page-1"><span>Disetujui</span></a></li>
            <li><a href="#page-2"><span>Ditolak</span></a></li>
        </ul>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="NAMA_UNIT_KERJA" HeaderText="Unit Kerja" SortExpression="NAMA_UNIT_KERJA" />
                                        <asp:BoundField DataField="StartDate" HeaderText="Tanggal Mulai" DataFormatString="{0:dd-MMM-yyyy}" SortExpression="StartDate" />
                                        <asp:BoundField DataField="EndDate" HeaderText="Tanggal Akhir" DataFormatString="{0:dd-MMM-yyyy}" SortExpression="EndDate" />
                                        <asp:BoundField DataField="Description" HeaderText="Deskripsi" SortExpression="Description" />
                                        <asp:BoundField DataField="StatusMail" HeaderText="Mail" SortExpression="StatusMail" />
                                        <asp:BoundField DataField="Type" HeaderText="Type" SortExpression="Type" />
                                        <asp:BoundField DataField="TotDay" HeaderText="Hari" SortExpression="TotDay" />
                                        <asp:TemplateField>
                                            <ItemTemplate>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gvwListApproved" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Type" HeaderText="Type" SortExpression="Type" />
                                        <asp:BoundField DataField="TotDay" HeaderText="Hari" SortExpression="TotDay" />
                                        <asp:BoundField DataField="Apv_Name" HeaderText="Disetujui Oleh" SortExpression="Apv_Name" />
                                        <asp:BoundField DataField="Approved_Date" HeaderText="Tanggal Setuju" DataFormatString="{0:dd-MMM-yyyy HH:mm}" SortExpression="Approved_Date" />
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnEdit" runat="server" CausesValidation="False" CommandName="Edit"
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gvwListRejected" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Type" HeaderText="Type" SortExpression="Type" />
                                        <asp:BoundField DataField="TotDay" HeaderText="Hari" SortExpression="TotDay" />
                                        <asp:BoundField DataField="Rjc_Name" HeaderText="Direject Oleh" SortExpression="Rjc_Name" />
                                        <asp:BoundField DataField="Rejected_Date" HeaderText="Tanggal Reject" DataFormatString="{0:dd-MMM-yyyy HH:mm}" SortExpression="Rejected_Date" />
                                        <asp:TemplateField>
                                            <ItemTemplate>
