<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="emppermitlst.aspx.cs"
    Inherits="module_form_emppermitlst" Title="Untitled Page" %>
    ...
    <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="search-header-table">
        <tr>
            <td colspan="2" style="border-bottom: solid 1px #dedede">
                <span class="search-header">Late and Leave Early List</span>
    ...
    <div id="pages" style="margin: 5px 3px">
            ...
            <table id="tblBody" cellpadding="3px" cellspacing="0px" class="search-list-table">
                <tr>
                    <td>
                        ...
                        <cc2:XUIButton ID="btnMail" runat="server" CssClass="mail" Text="Mail" OnClick="btnMail_Click" RoleCode="B100080" />
                    </td>
                    <td align="right">
        ...
        <div id="page-1" class="ui-corner-bottom" style="padding: 2px 2px; background-color: #eeeeff; color: #000; height: 430px; overflow-y: auto">
            <table id="tblApproved" cellpadding="3px" cellspacing="0px" class="search-list-table">
                <tr>
                    <td>
                        <cc2:XUIButton ID="btnPrint" runat="server" CssClass="print" Text="Print" OnClick="btnPrint_Click" RoleCode="B100065" /></td>
                    <td align="right">
