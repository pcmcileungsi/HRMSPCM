<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="exclaimlst.aspx.cs"
    Inherits="module_form_exclaimlst" Title="Untitled Page" %>
    ...
    <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="search-header-table">
        <tr>
            <td colspan="2" style="border-bottom: solid 1px #dedede">
                <span class="search-header">Expense Claim List</span>
    ...
    <div id="pages" style="margin: 5px 3px">
                    ...
                    <td colspan="2">
                        <asp:UpdatePanel ID="updMain" UpdateMode="Always" runat="server">
                            ...
                            <Triggers>
                                ...
                                <%--                                <asp:PostBackTrigger ControlID="gvwList" />--%>
                            </Triggers>
                        </asp:UpdatePanel>
                    </td>
                </tr>
        ...
        <div id="page-1" class="ui-corner-bottom" style="padding: 2px 2px; background-color: #eeeeff; color: #000; height: 430px; overflow-y: auto">
            <table id="tblHRD" cellpadding="3px" cellspacing="0px" class="search-list-table">
                ...
                <tr>
                    <td colspan="2">
                        <asp:UpdatePanel ID="updHRD" UpdateMode="Conditional" runat="server">
                            <ContentTemplate>
        ...
        <div id="page-3" class="ui-corner-bottom" style="padding: 2px 2px; background-color: #eeeeff; color: #000; height: 430px; overflow-y: auto">
            <table id="tblApproved2" cellpadding="3px" cellspacing="0px" class="search-list-table">
                <tr>
                    <td>
                        <cc2:XUIButton ID="btnPrint" runat="server" CssClass="print" Text="Print" OnClick="btnPrint_Click" RoleCode="B100083" />
                    </td>
                    <td align="right">
                ...
                <tr>
                    <td colspan="2">
                        <asp:UpdatePanel ID="updApproved2" UpdateMode="Conditional" runat="server">
                            <ContentTemplate>
