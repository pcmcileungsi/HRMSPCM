<%@ Page Title="Untitled Page" Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="leavedtl.aspx.cs" Inherits="module_master_leavedtl" %>
        ...
        <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="detail-header-table">
            <tr>
                <td colspan="2" style="border-bottom: solid 1px #dedede">
                    <span class="search-header">Leave Detail</span>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <tr>
                        ...
                        <td width="80%" colspan="2">
                            ...
                            <asp:RequiredFieldValidator ID="rfvStartDate" runat="server" ControlToValidate="txtStartDate"
                                ErrorMessage="* Harus diisi" />
                            <cc1:XUICheckBox ID="CheckHAlf" runat="server" Text="Half Day" Visible="false" AutoPostBack="true" OnCheckedChanged="CheckHAlf_CheckedChanged" />
                        </td>
                    </tr>
                    <tr>
                        <td width="20%">
