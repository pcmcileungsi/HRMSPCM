...
public partial class module_form_exclaimlst : BasePage
{
    ...
    {
        Response.Redirect("exclaimdtl.aspx?action=add");
    }
    ...
    private void BindGridHRD()
    {
        ...
        try
        {
            ...
            gvwListHRD.DataSource = _dalEmpExclaim.GetRows(_htParameters);
            gvwListHRD.DataBind();
        }
        catch (Exception ex)
        {
    ...
    private void BindGridApproved()
    {
        ...
        try
        {
            ...
            gvwListApproved.DataSource = _dalEmpExclaim.GetRows(_htParameters);
    ...
    private void BindGridApproved2()
    {
        ...
        try
        {
            ...
            gvwListApproved2.DataSource = _dalEmpExclaim.GetRows(_htParameters);
    ...
    private void BindGridRejected()
    {
        ...
        try
        {
            ...
            gvwListRejected.DataSource = _dalEmpExclaim.GetRows(_htParameters);
    ...
    protected void gvwListRejected_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case "Edit":
                Response.Redirect("exclaimdtl.aspx?action=edt&id=" + e.CommandArgument.ToString());
                break;
        }
    }
            ...
            if (row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (chb.Checked)
                {
                    try
                    {
                        ...
                        string rptName = Server.MapPath(@"..\..\rpt\RPT_LPD_PERSONAL.rpt");

                        // nama pdf yang akan dicreate dan path nya
                        string pdfName = "RPT_LPD_PERSONAL" + Utility.CurrentUID + DateTime.Now.ToString("ddMMyyyyHHmmss") + ".pdf";
                        ...
                        Utility.ExecuteReport(this, "sp_rpt_Personal_LPD", _htParameters, rptName, pdfPath, "RPT_LPD_PERSONAL");
                        listPDF.Add(pdfPath);
