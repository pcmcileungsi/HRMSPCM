...
public partial class module_data_jenpendtl : BasePage
{
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            Utility.ShowMessageBox(this, Utility.SAVE_DATA_SUCCESS_MESSAGE, null, "jenpendtl.aspx?action=edt&id=" + iNextID.ToString());
        }
        catch (Exception ex)
        {
