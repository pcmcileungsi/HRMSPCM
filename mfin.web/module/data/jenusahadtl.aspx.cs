...
public partial class module_data_jenusahadtl : BasePage
{
    ...
    private void LoadData()
    {
        ...
        try
        {
            ...
            DataTable _dt = _dalreff_jenis_usahaDAL.GetRow(_htParameters);
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            {
                _dalreff_jenis_usahaDAL.Insert(_htParameters, ref iNextID);
            }
            else
            {
                _dalreff_jenis_usahaDAL.Update(_htParameters);
                iNextID = Int32.Parse(lblid.Text);
            }

            Utility.ShowMessageBox(this, Utility.SAVE_DATA_SUCCESS_MESSAGE, null, "jenusahadtl.aspx?action=edt&id=" + iNextID.ToString());
        }
        catch (Exception ex)
        {
