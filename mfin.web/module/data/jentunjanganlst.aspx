<%@ Page Title="Jenis Tunjangan" Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="jentunjanganlst.aspx.cs" Inherits="module_data_jentunjanganlst" %>
    ...
    <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="search-header-table">
        <tr>
            <td colspan="2" style="border-bottom: solid 1px #dedede">
                <span class="search-header">List Jenis Tunjangan</span>
            </td>
        </tr>
        <tr>
            <td>
                <cc2:XUIButton ID="btnAdd" runat="server" CssClass="add" Text="Add" OnClick="btnAdd_Click" RoleCode="B100152" />
            </td>
            <td align="right">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Deskripsi" HeaderText="Jenis Tunjangan">
