...
public partial class module_data_jenusahalst : BasePage
{
    ...
    {
        Response.Redirect("jenposisidtl.aspx?action=add");
    }
    ...
    private void BindGrid()
    {
        ...
        try
        {
            ...
            gvwList.DataSource = _dalreff_jenis_posisiDAL.GetRows(_htParameters);
            gvwList.DataBind();
        }
        catch (Exception ex)
        {
    ...
    protected void gvwList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case "Edit":
                Response.Redirect("jenposisidtl.aspx?action=edt&id=" + e.CommandArgument);
                break;
            case "Delete":
                reff_jenis_posisiDAL _dalreff_jenis_posisiDAL = null;
                Hashtable _htParameters = null;
                ...
                try
                {
                    ...
                    _dalreff_jenis_posisiDAL.Delete(_htParameters);
                    this.BindGrid();
