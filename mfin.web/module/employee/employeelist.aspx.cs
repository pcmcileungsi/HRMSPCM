...
public partial class module_master_employeelist : BasePage
{
    ...
    protected void gvwList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case "Edit":
                Response.Redirect("Employeedetail.aspx?action=edt&id=" + e.CommandArgument);
                break;
            case "Delete":
                EmployeeDAL _dalEmployee = null;
                Hashtable _htParameters = null;
                ...
                try
                {
                    ...
                    _htParameters["p_Employee_ID"] = e.CommandArgument.ToString();

                    _dalEmployee.Delete(_htParameters);
                    this.BindGrid();
