...
public partial class module_pegawai_pegawailist : BasePage
{
    private static string _RoleCode = "B100133";
    ...
    #region GridViewHRD
    protected void btnSearchPEGAWAI_Click(object sender, EventArgs e)
    {
        BindGridHRD();
    }
    ...
    private void BindGridHRD()
    {
        ...
        try
        {
            ...
            _htParameters["p_keywords"] = txtSearchPEGAWAI.Text;
    ...
    private void BindGridApproved2()
    {
        ...
        try
        {
            ...
            gvwListApproved2.DataSource = _DALpelamar.GetRows(_htParameters);
