...
public partial class module_pegawai_kuotacutiimport : BasePage
{
    #region Load
    ...
    protected void btnLog_Click(object sender, EventArgs e)
    {
        ScriptManager.RegisterStartupScript(this, GetType(), "Log",
            "window.open('../../temp/txt/logUploadKuotaCutiPegawaiData.txt', 'Log', 'fullscreen=0,menubar=0,status=0,scrollbars=0,resizable=1,toolbar=0,width=600,height=400');",
            true);
    }
    ...
    private void CreateLog(string log)
    {
        ...
        var filepath = Server.MapPath(@"../../temp/txt/") + "logUploadKuotaCutiPegawaiData.txt";
        try
        {
