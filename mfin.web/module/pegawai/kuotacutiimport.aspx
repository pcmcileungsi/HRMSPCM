<%@ Page Title="Untitled Page" Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="kuotacutiimport.aspx.cs" Inherits="module_pegawai_kuotacutiimport" %>
        ...
        <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="detail-header-table">
            <tr>
                <td colspan="2" style="border-bottom: solid 1px #dedede">
                    <span class="search-header">Import Kuota Cuti</span>
                </td>
            </tr>
            <tr>
                <td>
