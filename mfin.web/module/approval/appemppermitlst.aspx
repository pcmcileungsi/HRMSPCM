<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="appemppermitlst.aspx.cs"
    Inherits="module_form_appemppermitlst" Title="Untitled Page" %>
    ...
    <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="search-header-table">
        <tr>
            <td colspan="2" style="border-bottom: solid 1px #dedede">
                <span class="search-header">Approval Late and Leave Early List</span>
    ...
    <div id="pages" style="margin: 5px 3px">
        ...
        <div id="page-0" class="ui-corner-bottom" style="padding: 2px 2px; background-color: #eeeeff; color: #000; height: 430px; overflow-y: auto">
            <table id="tblBody" cellpadding="3px" cellspacing="0px" class="search-list-table">
                <tr>
                    <td>
                        <cc1:XUIButton ID="btnApprove" runat="server" CssClass="post" Text="Approve Selected" OnClick="btnApprove_Click" RoleCode="B100090" />
                        <cc1:XUIButton ID="btnReject" runat="server" CssClass="void" Text="Reject" OnClick="btnReject_Click" RoleCode="B100090" />
                    </td>
                    <td align="right">
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TrxDate" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" SortExpression="TrxDate" />
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gvwListApproved" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Approved_Date" HeaderText="Approved Date" DataFormatString="{0:dd-MMM-yyyy}" SortExpression="Approved_Date" />
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnEdit" runat="server" CausesValidation="False" CommandName="Edit"
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gvwListRejected" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Rejected_Date" HeaderText="Reject Date" DataFormatString="{0:dd-MMM-yyyy}" SortExpression="Rejected_Date" />
                                        <asp:TemplateField>
                                            <ItemTemplate>
