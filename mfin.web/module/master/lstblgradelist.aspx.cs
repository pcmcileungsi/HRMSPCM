...
public partial class module_master_lstblgradelist : BasePage
{
    ...
    {
        Response.Redirect("lstblgradedetail.aspx?action=add");
    }
    ...
    private void BindGrid()
    {
        ...
        try
        {
            ...
            gvwList.DataSource = _dalLSTblGrade.GetRows(_htParameters);
            gvwList.DataBind();
        }
        catch (Exception ex)
        {
    ...
    protected void gvwList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case "Edit":
                Response.Redirect("lstblgradedetail.aspx?action=edt&id=" + e.CommandArgument);
                break;
            case "Delete":
                LStblGradeDAL _dalLSTblGrade = null;
                Hashtable _htParameters = null;
                ...
                try
                {
                    ...
                    _htParameters["p_ls_tblgradeid"] = e.CommandArgument.ToString();

                    _dalLSTblGrade.Delete(_htParameters);
                    this.BindGrid();
