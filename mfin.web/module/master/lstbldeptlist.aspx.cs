...
public partial class module_master_lstbldeptlist : BasePage
{
    ...
    {
        Response.Redirect("lstbldeptdetail.aspx?action=add");
    }
    ...
    private void BindGrid()
    {
        ...
        try
        {
            ...
            gvwList.DataSource = _dalLSTblDept.GetRows(_htParameters);
            gvwList.DataBind();
        }
        catch (Exception ex)
        {
    ...
    protected void gvwList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case "Edit":
                Response.Redirect("lstbldeptdetail.aspx?action=edt&id=" + e.CommandArgument);
                break;
            case "Delete":
                LStblDeptDAL _dalLSTblDept = null;
                Hashtable _htParameters = null;
                ...
                try
                {
                    ...
                    _htParameters["p_ls_tbldeptid"] = e.CommandArgument.ToString();

                    _dalLSTblDept.Delete(_htParameters);
                    this.BindGrid();
