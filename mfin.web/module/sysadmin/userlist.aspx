<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="userlist.aspx.cs" Inherits="module_sysadmin_userlist" Title="Untitled Page" %>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="False" DataKeyNames="USER_ID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="RoleDescs" HeaderText="User Role">
