...
public partial class module_sysadmin_usergrouplist : BasePage
{
    //private static string _RoleCode = "P000475";
    ...
    {
        Response.Redirect("usergroupdetail.aspx?action=add");
    }
    ...
    {
        Response.Redirect("usergroupdetail.aspx?action=edt&id=" + gvwList.SelectedDataKey[0].ToString());
    }
