...
public partial class module_sysadmin_master_msttunjanganjablist : BasePage
{
    //tes
    ...
    private void BindTahun()
    {
        ...
        try
        {
            ...
            ddlTahun.DataSource = _dalMST_TUNJANGAN_JABATAN_DAL.GetRowsTahun(_htParameters);
    ...
    protected void gvwList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case "Edit":
                Response.Redirect("msttunjanganjabdtl.aspx?action=edt&id=" + e.CommandArgument);
                break;
            case "Delete":
                MST_TUNJANGAN_JABATAN_DAL _dalMST_TUNJANGAN_JABATAN_DAL = null;
                Hashtable _htParameters = null;
                ...
                try
                {
                    ...
                    _dalMST_TUNJANGAN_JABATAN_DAL.Delete(_htParameters);
                    this.BindGrid();
