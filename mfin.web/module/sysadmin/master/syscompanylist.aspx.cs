...
public partial class module_sysadmin_master_syscompanylist : BasePage
{
    ...
    {
        Response.Redirect("syscompanydetail.aspx?action=add");
    }
    ...
    private void BindGrid()
    {
        ...
        try
        {
            ...
            gvwList.DataSource = _dalSysCompany.GetRows(_htParameters);
            gvwList.DataBind();
        }
        catch (Exception ex)
        {
        ...
        switch (e.CommandName)
        {
            ...
            case "Delete":
                ...
                try
                {
                    ...
                    _dalSysCompany.Delete(_htParameters);
    ...
    {
        Response.Redirect("syscompanydetail.aspx?action=edt&id=" + gvwList.SelectedDataKey[0].ToString());
    }
