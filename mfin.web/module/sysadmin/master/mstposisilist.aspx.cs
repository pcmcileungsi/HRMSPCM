...
public partial class module_sysadmin_master_mstposisilist : BasePage
{
    ...
    {
        Response.Redirect("mstposisidtl.aspx?action=add");
    }
    ...
    private void BindGrid()
    {
        ...
        try
        {
            ...
            gvwList.DataSource = _dalMST_POSISI.GetRows(_htParameters);
            gvwList.DataBind();
        }
        catch (Exception ex)
        {
    ...
    protected void gvwList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case "Edit":
                Response.Redirect("mstposisidtl.aspx?action=edt&id=" + e.CommandArgument);
                break;
            case "Delete":
                MST_POSISI_DAL _dalMST_POSISI = null;
                Hashtable _htParameters = null;
                ...
                try
                {
                    ...
                    _dalMST_POSISI.Delete(_htParameters);
                    this.BindGrid();
