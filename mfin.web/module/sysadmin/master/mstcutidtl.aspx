<%@ Page Title="Untitled Page" Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="mstcutidtl.aspx.cs" Inherits="module_sysadmin_master_mstcutidtl" %>
        ...
        <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="detail-header-table">
            <tr>
                <td colspan="2" style="border-bottom: solid 1px #dedede">
                    <span class="search-header">Data Master Majelis</span>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <ContentTemplate>
                <table id="tblBody" cellpadding="4px" cellspacing="0px" width="100%" border="0px">
                    ...
                    <tr>
                        ...
                        <td width="80%">
                            <cc1:XUITextBox ID="txtJmlHari" runat="server" DataType="String" DBColumnName="JML_HARI" onkeypress="return isNumber(event)"
                                BindType="Both" SPParameterName="p_JML_HARI" MaxLength="3" Width="50px"></cc1:XUITextBox>
                        </td>
                    </tr>                             
                </table>
            </ContentTemplate>
