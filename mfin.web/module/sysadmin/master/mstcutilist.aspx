<%@ Page Title="Untitled Page" Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="mstcutilist.aspx.cs" Inherits="module_sysadmin_master_mstcutilist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphbd" runat="Server">
    <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="search-header-table">
        ...
        <tr>
            <td>
                <cc2:XUIButton ID="btnAdd" runat="server" CssClass="add" Text="Add" OnClick="btnAdd_Click" RoleCode="B100110" />
            </td>
            <td align="right">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="NAMA" HeaderText="JENIS CUTI">
                                    <ItemStyle Width="80%" HorizontalAlign="Left" />
                                </asp:BoundField> 
                                 <asp:BoundField DataField="JML_HARI" HeaderText="JUMLAH HARI">
