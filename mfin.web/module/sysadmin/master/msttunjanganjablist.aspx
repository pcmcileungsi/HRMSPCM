<%@ Page Title="Untitled Page" Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="msttunjanganjablist.aspx.cs" Inherits="module_sysadmin_master_msttunjanganjablist" %>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DESKRIPSI" HeaderText="TUNJANGAN JABATAN">
