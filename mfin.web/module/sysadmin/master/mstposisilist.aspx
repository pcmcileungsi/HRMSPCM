<%@ Page Title="Untitled Page" Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="mstposisilist.aspx.cs" Inherits="module_sysadmin_master_mstposisilist" %>
    ...
    <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="search-header-table">
        <tr>
            <td colspan="2" style="border-bottom: solid 1px #dedede">
                <span class="search-header">List Posisi</span>
            </td>
        </tr>
        <tr>
            <td>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DESC_UNIT_KERJA" HeaderText="UNIT KERJA">
                                    <ItemStyle Width="40%" HorizontalAlign="Left" />
                                </asp:BoundField> 
                                <asp:BoundField DataField="DESC_POSISI" HeaderText="POSISI">
                                    <ItemStyle Width="40%" HorizontalAlign="Left" />
                                </asp:BoundField>                                
								<asp:CheckBoxField DataField="IS_SHIFT" HeaderText="SHIFT">
                                </asp:CheckBoxField>                               
                                <asp:CheckBoxField DataField="IS_CUTI" HeaderText="CUTI">
                                </asp:CheckBoxField>								
                                <asp:TemplateField>
                                    <ItemTemplate>
