<%@ Page Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="usergrouplist.aspx.cs" Inherits="module_sysadmin_usergrouplist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphbd" Runat="Server">
    <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="search-header-table">
        ...
        <tr>
            <td>
                <cc1:XUIButton ID="btnAdd" runat="server" CssClass="add" Text="Add" OnClick="btnAdd_Click" RoleCode="B100008" />
            </td>
            <td align="right">
        ...
        <tr>
            <td>
                <asp:UpdatePanel ID="updMain" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="False" DataKeyNames="USERGROUPID, USERGROUP"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="USERGROUPDESC" HeaderText="Usergroup Description">
