<%@ Page Title="Untitled Page" Language="C#" MasterPageFile="~/mfin.master" AutoEventWireup="true" CodeFile="hrreportlist.aspx.cs" Inherits="module_report_hrreportlist" %>
    ...
    <table id="tblHeader" cellpadding="3px" cellspacing="0px" class="search-header-table">
        <tr>
            <td style="border-bottom: solid 1px #dedede">
                <span class="search-header">HR Report List</span>
            </td>
        </tr>
        <tr>
            <td align="right">
