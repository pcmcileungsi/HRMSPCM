        ...
        <ContentTemplate>
            <div class="login">
                <span style="font-size: 18px; font-weight: bold; color: rgb(38,68,110);">H R M S
                     Login</span>
                <br />
                <span style="font-size: 12px; font-weight: bold; color: rgb(38,68,110);">Pimpinan Cabang Muhammadiyah Cileungsi.</span>
            ...
            <div style="width: 500px; margin: 0px auto; text-align: center; color: #ffffff;">
                <span>&copy; PCM Cileungsi, 2017. All rights reserved.</span>
            </div>
        </ContentTemplate>
