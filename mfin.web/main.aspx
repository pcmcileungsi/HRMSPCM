...
<body>
    <div id="hd" style="background-color: #16a085">
        <div id="inner" style="background-color: #16a085">
    ...
    <div id="bd">
        <table border="0px" cellpadding="0px" cellspacing="0" width="1002px">
            <tr>
                ...
                <td width="800px" valign="top" style="border-bottom: solid 1px #a6a6a6; border-left: solid 1px #a6a6a6; border-right: solid 1px #a6a6a6; background-color: #fff">
                    <iframe id="bd-right-ws" src="home.aspx" frameborder="0" name="bd-right-ws" width="100%"
                        height="850px" scrolling="auto"></iframe>
                </td>
            </tr>
        </table>
    </div>
